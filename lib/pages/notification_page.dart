...
import 'package:notes_app/main.dart';
                                  ...
                                  class _NotificationPageState extends State<NotificationPage> {
                                    ...
                                    bool _isNotificationAlreadyAdded(RemoteMessage message) {
                                      return globalNotifications.any((notification) => notification.messageId == message.messageId);
                                    }
                                                ...
                                                itemBuilder: (context, index) {
                                                  ...
                                                  return ListTile(
                                                    trailing: IconButton(
                                                      ...
                                                      onPressed: () {
                                                        setState(() {
                                                          ...
                                                          clickedNotifications.remove(index); // Remove from clicked map if deleted
                                                        });
                                                      },
                                                    ),
                                                    ...
                                                    title: Text(
                                                      ...
                                                      style: TextStyle(
                                                        fontWeight: clickedNotifications[index] == true ? FontWeight.normal : FontWeight.bold,
                                                      ),
                                                    ),
                                                    subtitle: Text(
